...
(cl:defmethod cl:initialize-instance :after ((m <GPS>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GPS)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ugv_msgs-msg:<GPS> is deprecated: use ugv_msgs-msg:GPS instead.")))

(cl:ensure-generic-function 'lat-val :lambda-list '(m))
(cl:defmethod lat-val ((m <GPS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ugv_msgs-msg:lat-val is deprecated.  Use ugv_msgs-msg:lat instead.")
  (lat m))

(cl:ensure-generic-function 'lng-val :lambda-list '(m))
(cl:defmethod lng-val ((m <GPS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ugv_msgs-msg:lng-val is deprecated.  Use ugv_msgs-msg:lng instead.")
  (lng m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <GPS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ugv_msgs-msg:speed-val is deprecated.  Use ugv_msgs-msg:speed instead.")
  (speed m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GPS>)))
  ...
  "e4f65926ca53cfcca37eb08ca1f88642")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GPS)))
  "Returns md5sum for a message object of type 'GPS"
  "e4f65926ca53cfcca37eb08ca1f88642")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GPS>)))
  ...
  (cl:format cl:nil "float64 lat~%float64 lng~%float64 speed~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GPS)))
  "Returns full string definition for message of type 'GPS"
  (cl:format cl:nil "float64 lat~%float64 lng~%float64 speed~%~%~%"))
