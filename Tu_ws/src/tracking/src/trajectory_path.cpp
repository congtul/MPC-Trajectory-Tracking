...
Matrix TrajectoryPath::generateTrajectoryPath(void)
{
  ...
  else if(this->trajectory_type == TrajectoryType::Custom)
  {
    ...
    std::cout << "size of path: " << num_point_list << std::endl;
    ...
    // for(int i = 0; i < num_point_list; i++)
    // {
    //   std::cout << "theta: " << ref_path(2,i)*180/3.14 << std::endl;
    // }
    return ref_path;
  }
}
